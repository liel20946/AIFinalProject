...
def main():
    ...
    # Step 2: Process these URLs and save the problem/solution matrices to a file
    export_to_file(url_list, path="data/image_parser_output.txt")

    # Step 3: Parse the saved files to extract problems and solutions
    problems, solutions = parse_saved_files(max_board_size=25, file_list=['data/image_parser_output.txt'])

    # Now you can proceed with these problems and solutions, e.g., for training a model or solving puzzles
